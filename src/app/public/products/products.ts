...
import { Categoria, DisponibilidadProducto, Producto } from '../../shared/models/domain.models';
...
export class Products implements OnInit {
  searchTerm = '';
  selectedCategoryId = '';
  selectedAvailability: '' | DisponibilidadProducto = '';
  ...
  loadProducts(): void {
    ...
    this.productService.getPublicProducts({
      ...
      disponibilidad: this.selectedAvailability || undefined,
